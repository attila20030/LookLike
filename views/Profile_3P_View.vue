<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile3P.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating3P }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p3p1.jpg" alt="" />
          <img class="work" src="../image/p3p2.jpg" alt="" />
          <img class="work" src="../image/p3p3.jpg" alt="" />
          <img class="work" src="../image/p3p4.jpg" alt="" />
          <img class="work" src="../image/p3p5.jpg" alt="" />
          <img class="work" src="../image/p3p6.jpg" alt="" />
        </ul>
       </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Piercing"],
      stats: [
        { label: "Contact: ", value: "JennyDa@email.org" },
        { label: "Location: ", value: "Oberelz" },
        { label: "Work Place: ", value: "HintH" }
      ],
      profileImage: "../image/profile3P.jpg",
      bio: [
        "Crafting your vibe one piercing at a time. Let’s adorn your uniqueness!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating3P = ratings.rating3P;
  },
};
</script>
