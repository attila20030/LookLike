<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile4P.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating4P }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p4p1.jpg" alt="" />
          <img class="work" src="../image/p4p2.jpg" alt="" />
          <img class="work" src="../image/p4p3.jpg" alt="" />
          <img class="work" src="../image/p4p4.jpg" alt="" />
          <img class="work" src="../image/p4p5.jpg" alt="" />
          <img class="work" src="../image/p4p6.jpg" alt="" />
        </ul>
       </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Piercing"],
      stats: [
        { label: "Contact: ", value: "ScottishBoy98@email.org" },
        { label: "Location: ", value: "Ussana" },
        { label: "Work Place: ", value: "Mistmorn" }
      ],
      profileImage: "../image/profile1.jpg",
      bio: [
        "Master of the needle and thread, crafting unique styles one piercing at a time. Let’s elevate your vibe and celebrate your individuality!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating4P = ratings.rating4P;
  },
};
</script>

<style src="../css/Profile_P.css" scoped></style>
