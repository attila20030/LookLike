<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile3H.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating3H  }}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p3h1.jpg" alt="" />
          <img class="work" src="../image/p3h2.jpg" alt="" />
          <img class="work" src="../image/p3h3.jpg" alt="" />
          <img class="work" src="../image/p3h4.jpg" alt="" />
          <img class="work" src="../image/p3h5.jpg" alt="" />
          <img class="work" src="../image/p3h6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      name: "Bristol Abegail",
      tags: ["Hairdresser"],
      stats: [
        { label: "Contact: ", value: "BALI@email.org" },
        { label: "Location: ", value: "Pontestura" },
        { label: "Work Place: ", value: "BitHair" }
      ],
      profileImage: "../image/profile3H",
      bio: [
        "Snipping away in style, I bring colors to life with every shade! 💖 Let's turn your hair dreams into a vibrant reality!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating3H = ratings.rating3H;
  },
};
</script>
