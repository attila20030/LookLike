<template>
  <div class="container">
    <div class="header-container">
      <img src="../image/p1h1g.gif" alt="" class="header-image" />
      <div class="header">
        <h1 class="main-heading">Ivan Tolly</h1>
    ...
    <div class="body">
      <img src="../image/profile1H.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating1H  }}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p1h1.jpg" alt="" />
          <img class="work" src="../image/p1h2.jpg" alt="" />
          <img class="work" src="../image/p1h3.jpg" alt="" />
          <img class="work" src="../image/p1h4.jpg" alt="" />
          <img class="work" src="../image/p1h5.jpg" alt="" />
          <img class="work" src="../image/p1h6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["Hairdresser"],
      stats: [
        { label: "Contact: ", value: "ETOlly@email.org" },
        { label: "Location: ", value: "Santa Fe, New Mexico" },
        { label: "Work Place: ", value: "UHair" }
      ],
      bio: ["Snipping and styling with a smile! ✂️💇‍♂️ Young hair magician bringing fresh looks to my friends."],
      works: [],
  ...
  mounted() {
    ...
    this.rating1H = ratings.rating1H;
  },
};
</script>

<style scoped src="../css/Profile_H.css"></style>
