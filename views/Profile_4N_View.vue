<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile4N.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating4N }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p4n1.jpg" alt="" />
          <img class="work" src="../image/p4n2.jpg" alt="" />
          <img class="work" src="../image/p4n3.jpg" alt="" />
          <img class="work" src="../image/p4n4.jpg" alt="" />
          <img class="work" src="../image/p4n5.jpg" alt="" />
          <img class="work" src="../image/p4n6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Nail Artist"],
      stats: [
        { label: "Contact: ", value: "Mel.Cel.sa@email.org" },
        { label: "Location: ", value: "Svelgen" },
        { label: "Work Place: ", value: "Nail Smith" }
      ],
      profileImage: "../image/profile4N.jpg",
      bio: [
        "Crafting tiny canvases, one nail at a time . Transforming dreams into dazzling designs!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating4N = ratings.rating4N;
  },
};
</script>
