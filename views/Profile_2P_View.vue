<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile2P.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating:{{rating2P}}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p2p1.jpg" alt="">
          <img class="work" src="../image/p2p2.jpg" alt="">
          <img class="work" src="../image/p2p3.jpg" alt="">
          <img class="work" src="../image/p2p4.jpg" alt="">
          <img class="work" src="../image/p2p5.jpg" alt="">
          <img class="work" src="../image/p2p6.jpg" alt="">
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["Piercing"],
      stats: [
        { label: "Contact: ", value: "Johnn.Lie99@email.org" },
        { label: "Location: ", value: "Albany" },
        { label: "Work Place: ", value: "Zazzy" }
      ],
      profileImage: "../image/profile2P.jpg",
      bio: [
        "Crafting unique looks one piercing at a time. Let's turn your vibe into an art piece!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating2P = ratings.rating2P;
  },
};
</script>
