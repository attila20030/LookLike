<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile2.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating2T }}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p2t1.jpg" alt="Tattoo 1" />
          <img class="work" src="../image/p2t2.jpg" alt="Tattoo 2" />
          <img class="work" src="../image/p2t3.jpg" alt="Tattoo 3" />
          <img class="work" src="../image/p2t4.jpg" alt="Tattoo 4" />
          <img class="work" src="../image/p2t5.jpg" alt="Tattoo 5" />
          <img class="work" src="../image/p2t6.jpg" alt="Tattoo 6" />
        </ul>
      </div>
    </div>
...
import { generateRandomRatings } from '@/stores/randomRatingT.js';
export default {
  components: {
  ...
  data() {
    ...
    return {
      ...
      tags: ["Tattoo Artist"],
      stats: [
        { label: "Contact: ", value: "UniqaEllie20@email.org" },
        { label: "Location: ", value: "Wolfville" },
        { label: "Work Place: ", value: "Asmodeus" }
      ],
      profileImage: "../image/profile2.jpg",
      bio: [
        "Ink flows through my veins, crafting bold stories on skin with every design. Let's turn your ideas into art—one tattoo at a time!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating2T = ratings.rating2T;
  },
};
</script>

<style src="../css/Profile_T.css" scoped></style>
