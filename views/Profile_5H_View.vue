<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile5H.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating5H  }}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p5h1.jpg" alt="" />
          <img class="work" src="../image/p5h2.jpg" alt="" />
          <img class="work" src="../image/p5h3.jpg" alt="" />
          <img class="work" src="../image/p5h4.jpg" alt="" />
          <img class="work" src="../image/p5h5.jpg" alt="" />
          <img class="work" src="../image/p5h6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["Hairdresser"],
      stats: [
        { label: "Contact: ", value: "Brade.Din@email.org" },
        { label: "Location: ", value: "Heyworth" },
        { label: "Work Place: ", value: "Alopec" }
      ],
      profileImage: "../image/profile5H.jpg",
      bio: [
        "Crafting styles and challenging norms one haircut at a time. Who said masculinity can't be fabulous?"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating5H = ratings.rating5H;
  },
};
</script>
