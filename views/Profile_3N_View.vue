<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile3N.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating3N }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p3n1.jpg" alt="" />
          <img class="work" src="../image/p3n2.jpg" alt="" />
          <img class="work" src="../image/p3n3.jpg" alt="" />
          <img class="work" src="../image/p3n4.jpg" alt="" />
          <img class="work" src="../image/p3n5.jpg" alt="" />
          <img class="work" src="../image/p3n6.jpg" alt="" />
        </ul>
     </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Nail Artist"],
      stats: [
        { label: "Contact: ", value: "LotusinTheLake@email.org" },
        { label: "Location: ", value: "Byske" },
        { label: "Work Place: ", value: "NAILEDIT" }
      ],
      profileImage: "../image/profile3N.jpg",
      bio: [
        "Nail artist spreading joy one polish at a time! 🎨💅 Transforming fingertips into works of art with every design!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating3N = ratings.rating3N;
  },
};
</script>
