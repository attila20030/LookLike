<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile4.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating4T }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p4t1.jpg" alt="" />
          <img class="work" src="../image/p4t2.jpg" alt="" />
          <img class="work" src="../image/p4t3.jpg" alt="" />
          <img class="work" src="../image/p4t4.jpg" alt="" />
          <img class="work" src="../image/p4t5.jpg" alt="" />
          <img class="work" src="../image/p4t6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      stats: [
        { label: "Contact: ", value: "merceri@email.org" },
        { label: "Location: ", value: "Toronto" },
        { label: "Work Place: ", value: "Valhalla Tattoo" }
      ],
      profileImage: "../image/profile4.jpg",
      bio: [
        "Inking my way through life, one skin canvas at a time. Let's turn your ideas into art!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating4T = ratings.rating4T;
  },
};
</script>
