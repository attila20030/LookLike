<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile3.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating3T }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p3t1.jpg" alt="" />
          <img class="work" src="../image/p3t2.jpg" alt="" />
          <img class="work" src="../image/p3t3.jpg" alt="" />
          <img class="work" src="../image/p3t4.jpg" alt="" />
          <img class="work" src="../image/p3t5.jpg" alt="" />
          <img class="work" src="../image/p3t6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["Tattoo Artist"],
      stats: [
        { label: "Contact: ", value: "RoseRick@email.org" },
        { label: "Location: ", value: "Amsterdam" },
        { label: "Work Place: ", value: "Sun & Moon" }
      ],
      profileImage: "../image/profile3.jpg",
      bio: [
        "Inked with passion and creativity, I empower women one tattoo at a time. Let's turn your skin into a canvas!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating3T = ratings.rating3T;
  },
};
