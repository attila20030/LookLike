<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile1.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{rating1T}}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p1t1.jpg" alt="" />
          <img class="work" src="../image/p1t2.jpg" alt="" />
          <img class="work" src="../image/p1t3.jpg" alt="" />
          <img class="work" src="../image/p1t4.jpg" alt="" />
          <img class="work" src="../image/p1t5.jpg" alt="" />
          <img class="work" src="../image/p1t6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["Tattoo Artist"],
      stats: [
        { label: "Contact: ", value: "brexton@email.org" },
        { label: "Location: ", value: "Asheville, North Carolina" },
        { label: "Work Place: ", value: "Valhalla" }
      ],
      bio: [
        "Inked dreams and skin stories, I bring art to life one tattoo at a time. Find me where creativity flows and ink spills magic."
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating1T = ratings.rating1T;
