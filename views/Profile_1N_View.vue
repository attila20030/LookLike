<template>
  <div class="container">
    <div class="header-container">
      <img src="../image/p1n1g.gif" alt="" class="header-image" />
      <div class="header">
        ...
        <h1 class="main-heading">Johnie Haylie</h1>
    ...
    <div class="body">
      <img src="../image/profile1N.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating1N }}</span>
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p1n1.jpg" alt="" />
          <img class="work" src="../image/p1n2.jpg" alt="" />
          <img class="work" src="../image/p1n3.jpg" alt="" />
          <img class="work" src="../image/p1n4.jpg" alt="" />
          <img class="work" src="../image/p1n5.jpg" alt="" />
          <img class="work" src="../image/p1n6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["Nail Artist"],
      stats: [
        { label: "Contact: ", value: "HeyNi@email.org" },
        { label: "Location: ", value: "Viver" },
        { label: "Work Place: ", value: "Artory" }
      ],
      bio: [
        "Creating magic one nail at a time! 🎨💅 Embracing colors and designs that make you shine!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating1N = ratings.rating1N;
  }
};
</script>

<style scoped src="../css/Profile_N.css"></style>
