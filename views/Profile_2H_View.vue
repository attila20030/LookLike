<template>
  <div class="container">
    <div class="header-container">
      <img src="../image/p2h1g.gif" alt="" class="header-image" />
      ...
      <div class="header">
        ...
        <h1 class="main-heading">Louisa Sienna</h1>
    ...
    <div class="body">
      <img src="../image/profile2H.jpg" :alt="name" class="body-image" />
     ...
     <div class="body-action-button-wrapper" style="position: relative;">
      ...
      <span class="body-stats">Rating: {{ rating2H  }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p2h1.jpg" alt="Hair Work 1" />
          <img class="work" src="../image/p2h2.jpg" alt="Hair Work 2" />
          <img class="work" src="../image/p2h3.jpg" alt="Hair Work 3" />
          <img class="work" src="../image/p2h4.jpg" alt="Hair Work 4" />
          <img class="work" src="../image/p2h5.jpg" alt="Hair Work 5" />
          <img class="work" src="../image/p2h6.jpg" alt="Hair Work 6" />
        </ul>
      </div>
    </div>
...
import { generateRandomRatings } from '@/stores/randomRatingH.js';
export default {
  components: {
  ...
  data() {
    ...
    return {
      ...
      tags: ["Hairdresser"],
      stats: [
        { label: "Contact: ", value: "SaSanna@email.org" },
        { label: "Location: ", value: "Asheville, North Carolina" },
        { label: "Work Place: ", value: "Barberry" }
      ],
      profileImage: "../image/profile2H.jpg",
      bio: [
        "Master of hues, I bring color to life one strand at a time. Your hair's new bestie, turning ordinary into extraordinary! ✂️✨ "
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating2H = ratings.rating2H;
  },
};
</script>

<style src="../css/Profile_H.css" scoped></style>
