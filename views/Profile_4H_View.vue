<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile4H.jpg" :alt="name" class="body-image" />
     ...
     <div class="body-action-button-wrapper" style="position: relative;">
      ...
      <span class="body-stats">Rating: {{ rating4H  }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p4h1.jpg" alt="" />
          <img class="work" src="../image/p4h2.jpg" alt="" />
          <img class="work" src="../image/p4h3.jpg" alt="" />
          <img class="work" src="../image/p4h4.jpg" alt="" />
          <img class="work" src="../image/p4h5.jpg" alt="" />
          <img class="work" src="../image/p4h6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Hairdreser"],
      stats: [
        { label: "Contact: ", value: "KiTTyCat@email.org" },
        { label: "Location: ", value: "Orrville" },
        { label: "Work Place: ", value: "Follica" }
      ],
      profileImage: "../image/profile3H.jpg",
      bio: [
        "Snipping and styling with a sprinkle of sparkle! 💇‍♀️✨ Bringing hair dreams to life, one fabulous look at a time!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating4H = ratings.rating4H;
  },
};
</script>
