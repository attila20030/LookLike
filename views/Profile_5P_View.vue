<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile5P.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{rating5P}}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p5p1.jpg" alt="" />
          <img class="work" src="../image/p5p2.jpg" alt="" />
          <img class="work" src="../image/p5p3.jpg" alt="" />
          <img class="work" src="../image/p5p4.jpg" alt="" />
          <img class="work" src="../image/p5p5.jpg" alt="" />
          <img class="work" src="../image/p5p6.jpg" alt="" />
        </ul>
     </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Piercing"],
      stats: [
        { label: "Contact: ", value: "MariAyla@email.org" },
        { label: "Location: ", value: "Perryville" },
        { label: "Work Place: ", value: "Obra" }
      ],
      profileImage: "../image/profile5P.jpg",
      bio: [
        "Crafting art and stories one piercing at a time. Let's make your unique mark shine!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating5P = ratings.rating5P;
  },
};
</script>
