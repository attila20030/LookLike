<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile5N.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{ rating5N }}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p5n1.jpg" alt="" />
          <img class="work" src="../image/p5n2.jpg" alt="" />
          <img class="work" src="../image/p5n3.jpg" alt="" />
          <img class="work" src="../image/p5n4.jpg" alt="" />
          <img class="work" src="../image/p5n5.jpg" alt="" />
          <img class="work" src="../image/p5n6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return { 
      ...
      tags: ["Nail Artist"],
      stats: [
        { label: "Contact: ", value: "Finle76@email.org" },
        { label: "Location: ", value: "Oslo" },
        { label: "Work Place: ", value: "Noxy" }
      ],
      profileImage: "../image/profile5N.jpg",
      bio: [
        "Nail artist by day, sparkle magician by night! 💅✨ Turning nails into tiny canvases of joy and creativity!"
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating5N = ratings.rating5N;
  },
};
</script>
