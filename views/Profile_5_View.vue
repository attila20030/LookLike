<template>
  <div class="container">
    ...
    <div class="body">
      <img src="../image/profile5.jpg" :alt="name" class="body-image" />
      ...
      <span class="body-stats">Rating: {{rating5T}}</span>
      <div class="body-info">
      ...
      <div class="card u-clearfix">
        ...
        <ul class="card-list">
          ...
          <img class="work" src="../image/p5t1.jpg" alt="" />
          <img class="work" src="../image/p5t2.jpg" alt="" />
          <img class="work" src="../image/p5t3.jpg" alt="" />
          <img class="work" src="../image/p5t4.jpg" alt="" />
          <img class="work" src="../image/p5t5.jpg" alt="" />
          <img class="work" src="../image/p5t6.jpg" alt="" />
        </ul>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      name: "Tim Joby",
      tags: ["Tattoo Artist", "Piercing"],
      stats: [
        { label: "Contact: ", value: "TimJob21@email.org" },
        { label: "Location: ", value: "Incheon" },
        { label: "Work Place: ", value: "Sun & Moon" }
      ],
      profileImage: "../image/profile5.jpg",
      bio: [
        "Ink slinger by day, art creator by night. Creating stories on skin, one tattoo at a time."
      ],
      works: [],
  ...
  mounted() {
    ...
    this.rating5T = ratings.rating5T;
  },
};
